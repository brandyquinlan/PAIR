      ...
      .then(function (response) {
        ...
        for (let i = 0; i < 6; i++) {
          var col = $('<div>').attr('class', 'col s6'),
            ...
            contentSpan = $('<span>').attr('class', 'card-title activator grey-text text-darken-4').text("Recipie name"),
            ...
            hr = $('<hr>'),
            ul = $('<ul>'),
            prepTime = $('<li>').attr('id', 'prepTimeReveal').text('Prep time: ' + 'var here'),
            br1 = $('<br>'),
